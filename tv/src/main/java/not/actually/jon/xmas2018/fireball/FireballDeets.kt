 ...
 */
class FireballDeets : DetailsFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSelectedMovie = activity.intent.getSerializableExtra(FireballDetailsActivity.MOVIE) as Movie
        if (mSelectedMovie != null) {
            ...
            val intent = Intent(activity, FireballActivity::class.java)
    ...
    private fun setupDetailsOverviewRowPresenter() {
        ...
        sharedElementHelper.setSharedElementEnterTransition(
                activity, FireballDetailsActivity.SHARED_ELEMENT_NAME)
        ...
        detailsPresenter.onActionClickedListener = OnActionClickedListener { action ->
            if (action.id == ACTION_WATCH_TRAILER) {
                ...
                intent.putExtra(FireballDetailsActivity.MOVIE, mSelectedMovie)
                startActivity(intent)
            } else {
    ...
    private inner class ItemViewClickedListener : OnItemViewClickedListener {
        override fun onItemClicked(
            ...
            if (item is Movie) {
                ...
                val intent = Intent(activity, FireballDetailsActivity::class.java)
                ...
                val bundle =
                        ActivityOptionsCompat.makeSceneTransitionAnimation(
                                ...
                                FireballDetailsActivity.SHARED_ELEMENT_NAME)
                                .toBundle()
